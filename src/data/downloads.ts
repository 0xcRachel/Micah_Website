...
export const DOWNLOAD_DATA: DownloadRelease = {
  ...
  primaryDownloadUrl: "https://github.com/0xcRachel/Micah_0xC/releases/download/v1.0.0/Micah_0xC_1.0.0_x64-setup.exe",
  primaryFilename: "Micah_0xC_1.0.0_x64-setup.exe",
